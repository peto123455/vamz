...
public final class AboutBinding implements ViewBinding {
  ...
  private AboutBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
  ...
  public static AboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AboutBinding((ConstraintLayout) rootView, imageView, textView);
    }
