...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView itemDate,
      @NonNull TextView itemTitle, @NonNull ImageButton removeButton,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemBinding((ConstraintLayout) rootView, itemDate, itemTitle, removeButton,
          resultImage);
    }
